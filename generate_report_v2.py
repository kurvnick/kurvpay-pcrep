...
# ── HTML GENERATION ───────────────────────────────────────────────────────────
def generate_html(d1, d2, acct_days, data, analysis_html=""):
    rows = data["rows"]
    n    = len(rows)
...
<div class="page">
  ...
  <div class="masthead">
    ...
    <div class="masthead-right">
      ...
      Approvals: Approved / Conditionally Approved / Auto Approved<br>
      <span style="font-size:10px">Updated: {now_pt}</span>
    </div>
  </div>
...
def main():
    ...
    team_stats_cur = {"conlan": _tstats_v2(CONLAN), "stokoe": _tstats_v2(STOKOE)}
    ...
    html = generate_html(d1, d2, acct_days, data, analysis_html=analysis_html)
